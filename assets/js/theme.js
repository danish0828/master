...
// Get the carousel items and navigation arrows
const carouselItems = document.querySelectorAll(".carousel-item");
const prevArrow = document.querySelector(".prev-arrow");
const nextArrow = document.querySelector(".next-arrow");
let currentItemIndex = 0;
let autoplayInterval;
// Function to show the current carousel item with fade transition
const showCarouselItem = () => {
  ...
  // Show the current carousel item with fade-in effect
  carouselItems[currentItemIndex].style.display = "flex";
  fadeIn(carouselItems[currentItemIndex]);
};
...
const navigateToPreviousItem = () => {
  currentItemIndex--;
  // If currentItemIndex becomes less than 0, wrap around to the last item
...
const navigateToNextItem = () => {
  currentItemIndex++;
  // If currentItemIndex exceeds the last item index, wrap around to the first item
